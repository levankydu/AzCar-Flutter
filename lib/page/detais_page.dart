                                      ...
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            ...
                                            actions: [
                                              if (isPopLoading) CircularProgressIndicator() else Row(
                                                children: [
                                                  TextButton(
                                                    onPressed: () async {
                                                      setState(() {
                                                      ...
                                                      final response = await http.get(
                                                          Uri.parse('${ApiService.baseUrl}/api/cars/ownerAccepted?orderId=${order.id}'),
                                                ...
                                                children: [
                                                  TextButton(
                                                    onPressed: () async {
                                                      ...
                                                      final response = await http.get(
                                                          Uri.parse('${ApiService.baseUrl}/api/cars/ownerDeclined?orderId=${order.id}'),
                                                          headers: {'Content-Type': 'application/json'});
                                                      Navigator.of(context).pop();
                                                      if (response.statusCode == 200) {
                                                        await Fluttertoast.showToast(
